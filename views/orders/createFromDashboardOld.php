                ...
                <table class="table table-bordered" id="product_info_table">
                  <thead>
                   ...
                   <tbody>
                     <tr id="row_1">
                       <td>
                           <select class="form-control select_group" data-row-id="row_1" id="product_1"  name="product[]" style="width:100%;" onchange="getProductData(1)" autofocus required>
            ...
            //           html +='</datalist>'+
              ...
              // console.log(reponse.x);
               var html = '<tr id="row_'+row_id+'">'+
                   '<td>'+ 
                        '<select class="select_group form-control" data-row-id="'+row_id+'" id="product_'+row_id+'" name="product[]" style="width:100%;" onchange="getProductData('+row_id+')" >';
                            $.each(response, function(index, value) {
                                html += '<option value="'+value.sr_no+'">'+value.name+'</option>';             
                            });
                        html += '</select>'+
