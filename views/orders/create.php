                ...
                <table class="table table-bordered" id="product_info_table">
                  <thead>
                   ...
                   <tbody>
                     <tr id="row_1">
                          <td>
                        <input autofocus list="test_1" class="form-control" data-row-id="row_1" id="product_1"  name="product[]" style="width:100%;" onchange="getProductData(1)" required>
                            <datalist id="test_1" >
                            <option value=""></option>
                            <?php foreach ($products as $k => $v): ?>
                              <option value="<?php echo $v['sr_no'] ?>"><?php echo $v['name'] ?></option>
                            <?php endforeach ?>
                          </datalist>
                      </td>
          ...
          success:function(response) {
            ...
            //   console.log(reponse);
               var html = '<tr id="row_'+row_id+'">'+
                            '<td>'+
                                '<input list="test_'+row_id+'" class="form-control select_group sr_no " data-row-id="'+row_id+'" id="product_'+row_id+'" name="product[]" style="width:100%;" onchange="getProductData('+row_id+')">'+
                                   '<datalist id="test_'+row_id+'" >'+
                                    '<option value=""></option>';
                                        $.each(response, function(index, value) {
                                          html += '<option value="'+value.sr_no+'">'+value.name+'</option>';
                                        });
                                     html += '</datalist>'+
                                '</td>'+ 
                            ...
                            '</td>'+
                             ...
                             '<td><input type="text" name="product_name[]" id="product_name_'+row_id+'" class="form-control" ></td>'+
      ...
      $.ajax({
        ...
        success:function(response) {
          ...
          console.log(response);
           ...
           $("#product_name_"+row_id).val(response.product_name);
          $("#product_name_value_"+row_id).val(response.product_name);
