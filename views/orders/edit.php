        ...
        <div class="box">
          ...
          <form role="form" action="<?php base_url('orders/create') ?>" method="post" class="form-horizontal">
                    ...
                    <?php if(isset($order_data['order_item'])): ?>
                      ...
                      <?php foreach ($order_data['order_item'] as $key => $val): ?>
                       ...
                       <tr id="row_<?php echo $x; ?>">
                           <td>
                        <input list="test_1" class="form-control" data-row-id="row_1" id="product_1"  name="product[]" style="width:100%;" onchange="getProductData(1)" required>
                            <datalist id="test_1" >
                            <option value=""></option>
                        ...
                        <td>
                          <input type="text" name="unit[]" id="unit_<?php echo $x; ?>" class="form-control" disabled autocomplete="off" value="<?php echo $val['unit'] ?>">
                          <input type="hidden" name="unit_value[]" id="unit_value_<?php echo $x; ?>" class="form-control" autocomplete="off" value="<?php echo $val['unit'] ?>">
                        </td>

                        <td>
                         <input type="text" name="gst[]" id="gst_<?php echo $x; ?>" class="form-control" disabled autocomplete="off"  value="<?php echo $val['gst'] ?>">
                          <input type="hidden" name="gst_value[]" id="gst_value_<?php echo $x; ?>" class="form-control" autocomplete="off" value="<?php echo $val['gst'] ?>">
                        </td>
                       
                        <td>
                         <input type="text" name="hsn[]" id="hsn_<?php echo $x; ?>" class="form-control" disabled autocomplete="off"  value="<?php echo $val['hsn'] ?>">
                          <input type="hidden" name="hsn_value[]" id="hsn_value_<?php echo $x; ?>" class="form-control" autocomplete="off" value="<?php echo $val['hsn'] ?>">
                        </td>
                          ...
                          <td>
                            ...
                            <input type="hidden" name="total_gst_rate_value[]" id="total_gst_rate_value_1" class="form-control" autocomplete="off" value="<?php echo $order_data['order']['totalgst'] ?>">
                          </td>
                          <td>
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo base_url('orders/create') ?>" class="btn btn-warning">Back</a>
              </div>
            </form>
          <!-- /.box-body -->
        </div>
      ...
      $.ajax({
        ...
        success:function(response) {
          ...
          $("#qty_value_"+row_id).val(1);
           ...
           var cgst_value = $('#cgst_value_'+row_id).val();

         
          var sgst_value = $('#sgst_value_'+row_id).val();
      
      
          var cgstTotal_value = ((total * cgst_value)/100);
