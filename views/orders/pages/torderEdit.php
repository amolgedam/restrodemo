...
<!--< ?php echo error_reporting(0); // error_reporting(E_ERROR | E_PARSE); ?>-->
    ...
    // echo "<pre>"; print_r($orderItemData); 
    // exit();
...
<?php
  $table = $this->model_tables->getTableData($orderData['table_id']);
...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <?php echo form_open('order/updateTableOrder'); ?>
      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">
              <span style="padding-left: 11px; font-size: 28px"><i class="fa fa-edit"></i> &nbsp; Edit Order</span>
            </h3>
          </div>
          <!-- /.box-header -->
              <div class="box-body" style="margin-top: 40px">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="hidden" class="form-control" value="<?php echo $orderData['id']; ?>" name="order_id" readonly />

                    <input type="hidden" class="form-control" value="<?php echo $orderData['ordertype']; ?>" name="tran_type" readonly />
                    <input type="text" class="form-control" value="<?php echo $orderData['bill_no']; ?>" name="invoice" readonly />
                  </div>
                </div>

                <div class="col-md-4">
                  <div class="form-group">
                    <label for="product_name">Table</label>
                    <input type="hidden" class="form-control" name="table_id" value="<?php echo $table['id'] ?>" readonly=""/>
                    <input type="text" class="form-control" name="table_name" value="<?php echo $table['table_name'] ?>" readonly=""/>
                  </div>
                </div>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" name="cname" value="<?php echo $orderData['customername'] ?>" class="form-control" placeholder="Customer Name"/>
                  </div>
                </div>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="<?php echo $orderData['mobile'] ?>" name="mobile" placeholder="Mobile"/>
                  </div>
                </div>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="hidden" name="emp" id="empid" class="form-control" value="<?php echo $waiterData['id'] ?>" readonly>

                      <input list="test_1" class="form-control" id="empname"  name="empname[]" autofocus autocomplete="off" value="<?php echo $waiterData['name'] ?>">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <select name="salestype" class="form-control">
                      ...
                      ?>
                          <option value="<?php echo $value->id; ?>" <?php echo $orderData['sales_type'] == $value->id ? "selected" : ""; ?> ><?php echo ucwords($value->name); ?></option>
                      <?php
                        }
                      ?>
                    </select>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <select name="paymenttype" class="form-control" id="ptype">
                      ...
                      ?>
                          <option value="<?php echo $value->id; ?>" <?php echo $orderData['payment_term'] == $value->id ? "selected" : ""; ?> ><?php echo ucwords($value->name); ?></option>
                      <?php
                        }
                      ?>
                    </select>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="finalgprice" name="finalgprice" placeholder="Gross Price" autocomplete="off" value="<?php echo $orderData['gross_amount'] ?>" readonly />
                  </div>
                </div>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="finaldiscount" name="finaldiscount" placeholder="Discount" autocomplete="off" value="<?php echo $orderData['discount'] ?>"  readonly />
                  </div>
                </div>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="finalGst" name="finalGst" placeholder="GST" autocomplete="off" readonly="" value="<?php echo $orderData['totalgst'] ?>"  />
                  </div>
                </div>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="adj" id="adj" placeholder="Adjustment" value="<?php echo $orderData['adj'] ?>"  />
                  </div>
                </div>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="hidden" class="form-control" id="finalnetAmt2" name="finalnetAmtAdj" placeholder="Net Amount" autocomplete="off" readonly="" value="<?php echo $orderData['net_amount'] ?>"  />
                    <input type="text" class="form-control" id="finalnetAmt" name="finalnetAmt" placeholder="Net Amount" autocomplete="off" readonly="" value="<?php echo $orderData['fnetamt'] ?>"  />
                  </div>
                </div>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <select name="billstatus" class="form-control" id="paidStatus">
                      <option value="2" <?php echo $orderData['paid_status'] == "2" ? "selected" : ""; ?> >Unpaid</option>
                      <option value="1" <?php echo $orderData['paid_status'] == "1" ? "selected" : ""; ?> >Paid</option>
                    </select>
                  </div>
                </div>
                      ...
                      <div class="col-md-5">
                            <!-- <div class="pull-right" style="padding-right: 20px"> -->
                              ...
                              <label>Invoice Discount</label>
                                ...
                                <input type="text" name="inDisPer" id="inDisPer" class="form-control">
                              </div>
                              <div class="col-md-6">
                                <br>
                                <a href="javascript:void(0);" id="btnDisAdd" style="margin-top: 5px;" class="btn btn-danger">%</a>
                          ...
                          ?>
                            ...
                            <tr id="row_<?php echo $row_id; ?>">
                                <td>
                                    ...
                                    <input type="hidden" name="orderitem_id[]" id="orderitemid_<?php echo $row_id; ?>" value="<?php echo $value['id'] ?>"/>



                                    <input type="hidden" name="kot_status[]" id="kot_<?php echo $row_id; ?>" value="<?php echo $value['kot_status'] ?>"/>

                                    <input type="hidden" name="product_id[]" id="productid_<?php echo $row_id; ?>" value="<?php echo $product['id'] ?>"/>

                                    <input type="hidden" name="product_name[]" id="productname_<?php echo $row_id; ?>"  value="<?php echo $product['name'] ?>"/>

                                    <span><?php echo $product['name'] ?></span>
                                </td>

                                <td>
                                    <span><?php echo $unitData['name'] ?></span>
                                </td>
                                <td>
                                    <input type="hidden" name="gstID[]" id="gst_<?php echo $row_id; ?>" value="<?php echo $gstData['gst_id']; ?>" />

                                    <span><?php echo $gstData['name'] ?></span>
                                </td>

                                <td>
                                    <input type="text" name="quantity[]" id="quantity_<?php echo $row_id; ?>" value="<?php echo $value['qty'] ?>" style="width: 60px" onchange="getConversionData(<?php echo $row_id; ?>)" <?php echo $read; ?> />
                                </td>

                                <td>
                                    <input type="text" name="mrp[]" onchange="mrpChange1(<?php echo $row_id; ?>)"  id="baseprice_<?php echo $row_id; ?>" value="<?php echo $value['rate']; ?>" style="width: 60px" <?php echo $read; ?>/>
                                </td>

                                <td>
                                    <input type="text" name="discount[]" id="discount_<?php echo $row_id; ?>" value="<?php echo $value['discount']; ?>" style="width: 60px" onchange="getDiscount(<?php echo $row_id; ?>)" <?php echo $read; ?> />
                                </td>

                                <td>
                                    <input type="text" name="discountAmt[]" id="disvalue_<?php echo $row_id; ?>" value="<?php echo $value['discountAmt']; ?>" class="dislist" readonly style="width: 60px"/>
                                </td>

                                <td>
                                    <input type="text" name="grossprice[]" id="grossprice_<?php echo $row_id; ?>" value="<?php echo $value['grossprice']; ?>" class="gpricelist" readonly style="width: 100px" <?php echo $read; ?> />

                                    <input type="hidden" name="hgrossprice[]" id="hgrossprice_<?php echo $row_id; ?>" value="<?php echo $value['grossprice']; ?>" readonly>
                                                    
                                    <input type="hidden" name="hgrossprice1[]" id="hgrossprice1_<?php echo $row_id; ?>" value="<?php echo $value['grossprice']; ?>" readonly>
                                                    
                                    <!-- // for cal gst on discount -->
                                    <input type="hidden" name="baseprice[]" id="hiddenbaseprice_<?php echo $row_id; ?>" value="<?php echo $value['grossprice']; ?>" class="bpclass" readonly>

                                    <input type="hidden" name="hiddenbaseprice1[]" id="hiddenbaseprice1_<?php echo $row_id; ?>" value="<?php echo $value['grossprice']; ?>" readonly>
                                </td>

                                <td>
                                    <input type="text" name="gstAmt[]" id="gstamt_<?php echo $row_id; ?>" value="<?php echo $value['gstAmt']; ?>" readonly class="gstAmtList" style="width: 90px" <?php echo $read; ?> />

                                    <input type="hidden" name="hgstamt[]" id="hgstamt_<?php echo $row_id; ?>" readonly value="<?php echo $value['gstAmt']; ?>">
                                                    
                                    <input type="hidden" name="hgstamt1[]" id="hgstamt1_<?php echo $row_id; ?>" readonly value="<?php echo $value['gstAmt']; ?>">

                                </td>

                                <td>
                                    <input type="text" name="netAmt[]" id="finalprice_<?php echo $row_id; ?>" value="<?php echo $value['netAmt']; ?>" class="netAmtList" readonly style="width: 90px" <?php echo $read; ?> />

                                    <input type="hidden" name="hfinalprice[]" id="hfinalprice_<?php echo $row_id; ?>" value="<?php echo $value['netAmt']; ?>" readonly>
                                                    
                                    <input type="hidden" name="hfinalprice1[]" id="hfinalprice1_<?php echo $row_id; ?>" value="<?php echo $value['netAmt']; ?>" readonly>
                                </td>

                                <td>
                                  <?php if($value['kot_status'] != 1){ ?>
                                    <a href="javascript:void(0);" class="btn btn-success btn-sm"><i class="fa fa-print"></i></a>
                                  <?php }else{ ?>
                                    <a href="javascript:void(0);" class="btn btn-danger btn-sm remove"><i class="fa fa-trash"></i></a>
                                  <?php } ?>
                                </td>
                      ...
                      success:function(responseGst1) {
                          ...
                          html += '<tr id="row_'+row_id+'">';
                              ...
                              html += '<td>';
                                ...
                                html += '<input type="hidden" name="kot_status[]" id="kot_'+row_id+'" value="1" />'; 

                                html += '<input type="hidden" name="product_id[]" id="productid_'+row_id+'" value="'+response.id+'"/>';


                                // html += '<input type="text" name="product_id[]" id="productid_'+row_id+'" value="'+response.id+'"/>';
...
<script type="text/javascript">
  $(document).ready(function(){
      ...
      $('#btnDisAdd').on('click', function(){
          ...
          var per = parseFloat($('#inDisPer').val());
          ...
          else
          {
              ...
              for (var i = 1; i <= row_id; i++) {
                  ...
                  console.log(i);
                  var perOld = parseFloat($('#discount_'+i).val());

                  var newPer = perOld + per;
                  
                  console.log(newPer);
                  $('#discount_'+i).val(newPer);
