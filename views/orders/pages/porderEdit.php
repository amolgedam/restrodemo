...
<?php
  $table = $this->model_parcel->getTableData($orderData['parcel_id']);
...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <?php echo form_open('order/updateParcel'); ?>
              ...
              <div class="box-body" style="margin-top: 40px">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" name="cname" value="<?php echo $orderData['customername'] ?>" class="form-control" autofocus placeholder="Customer Name"/>
                  </div>
                </div>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" value="<?php echo $orderData['mobile'] ?>" class="form-control" name="mobile" placeholder="Mobile"/>
                  </div>
                </div>
