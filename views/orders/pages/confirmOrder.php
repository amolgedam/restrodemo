        ...
        <div class="box">
            ...
            <div class="box-body" style="margin-top: 40px">
                ...
                <!-- <div class="form-group">
                  ...
                  <?php
                      ...
                      $table = $this->model_tables->getTableData($data['table_id']);
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" name="cname" value="<?php echo $data['customername'] ?>" class="form-control" readonly placeholder="Customer Name"/>
                  </div>
                </div>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="<?php echo $data['mobile'] ?>" name="mobile" readonly placeholder="Mobile"/>
                  </div>
                </div>
          ...
          <div class="box-footer" style="text-align: right; padding-right: 20px;">
            ...
            <?php if($data['paid_status'] != 1){ ?>
              ...
              <a href="<?php echo base_url() ?>order/updateTableOrder/<?php echo $order_id ?>" class="btn btn-sm btn-success">Edit Invoice</a>
            <?php } ?>
