        ...
        <div class="col-md-12 col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><span style="padding-left: 0px; font-size: 28px"><i class="fa fa-plus-square" aria-hidden="true"></i> Add Group</h3>
            </div>
            <form role="form" action="<?php base_url('groups/create') ?>" method="post">
              ...
              <div class="box-footer" >
                ...
                <a href="<?php echo base_url('groups/') ?>" class="btn btn-danger">Close</a>
