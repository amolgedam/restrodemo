        ...
        <div class="col-md-12 col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><span style="padding-left: 0px; font-size: 28px"><i class="fa fa-address-book" aria-hidden="true"></i> Parcel</h3>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h3 class="modal-title"><i class="fa fa-plus-square"></i> Add Parcel</h3>
      </div>

      <form role="form" action="<?php echo base_url('parcel/create') ?>" method="post" id="createForm">

        <div class="modal-body">

          <div class="form-group">
            <label for="brand_name">Parcel Name</label>
            <input type="text" class="form-control" id="parcel_name" name="parcel_name" placeholder="Enter Parcel name" autocomplete="off">
          </div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="editModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h3 class="modal-title"><i class="fa fa-plus-square"></i> Edit Parcel</h3>
      </div>

      <form role="form" action="<?php echo base_url('parcel/update') ?>" method="post" id="updateForm">
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('parcel/remove') ?>" method="post" id="removeForm">
        <div class="modal-body">
...
$(document).ready(function() {
  ...
  manageTable = $('#manageTable').DataTable({
    'ajax': base_url + 'parcel/fetchTableData',
    'order': []
  });
...
{ 
  $.ajax({
    url: base_url + 'parcel/fetchTableDataById/'+id,
    type: 'post',
    dataType: 'json',
    success:function(response) {
