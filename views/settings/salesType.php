        ...
        <div class="col-md-12 col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><span style="padding-left: 0px; font-size: 28px"><i class="fa fa-address-book" aria-hidden="true"></i> Sales Type</span></h3>
...
<!-- MODAL Add-->
  <form role="form" action="<?php echo base_url('sales_type/create') ?>" method="post" id="createForm">
      <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h3 class="modal-title" id="exampleModalLabel"><i class="fa fa-plus-square"></i> Add Sales Type</h3>
            ...
            <!-- <form role="form" action="< ?php echo base_url('tables/create') ?>" method="post" id="createForm"> -->
              ...
              <div class="modal-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="name" name="name" placeholder="Enter Sales Type" autocomplete="off" required>
                </div>
  ...
  <!-- MODAL Edit-->
  <form role="form" action="<?php echo base_url('sales_type/updateSales') ?>" method="post" id="editForm">
      <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h3 class="modal-title" id="exampleModalLabel"><i class="fa fa-edit"></i> Update Sales Type</h3>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
              ...
              <div class="modal-body">
                ...
                <div class="form-group">
                  <label for="brand_name">Name</label>
                  <input type="text" class="form-control" id="name_edit" name="name_edit" placeholder="Enter Sales Type" autocomplete="off" required>
                </div>
  ...
  <!-- MODAL Edit-->
  <form role="form" action="<?php echo base_url('sales_type/deleteSalesType') ?>" method="post" id="deleteForm">
  ...
  <!-- MODAL Edit-->
  <form role="form" action="<?php echo base_url('sales_type/statusChange') ?>" method="post" id="deleteForm">
