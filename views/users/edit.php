        ...
        <div class="col-md-12 col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"> <span style="padding-left: 0px; font-size: 28px"><i class="fa fa-edit" aria-hidden="true"></i> Edit User</h3>
            </div>
                  ...
                  <div class="form-group">
                    ...
                    <!-- <select class="form-control" name="emp">
                      ...
                      < ?php foreach ($emp as $k => $v): ?>
                        <option value="< ?php echo $v->id ?>" < ?php echo $v->id == $user_data['emp_id'] ? "Selected" : ""; ?> >< ?php echo $v->name; ?></option>
                      < ?php endforeach ?>
                    </select> -->

                    <?php
                      $waiterData = $this->model_waiter->fecthAllDataById($user_data['emp_id']);
                    ?>

                    <input type="hidden" name="emp" id="emp" value="<?php echo $user_data['emp_id'] ?>" class="form-control" readonly>

                    <input list="test_1" class="form-control" id="empname" value="<?php echo $waiterData['name']; ?>" name="empname[]" autofocus required>
                      <datalist id="test_1">
                      <?php foreach ($emp as $k => $v): ?>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <select class="form-control" name="status">
                      <option value="1" <?php echo $user_data['loginstatus'] == '1' ? "selected" : ""; ?>>Active</option>
                      <option value="0" <?php echo $user_data['loginstatus'] == '0' ? "selected" : ""; ?>>Inactive</option>
                    </select>
                  </div>
                </div>
<!-- 
