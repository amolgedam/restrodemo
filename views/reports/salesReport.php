      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
             <h3 class="box-title"><span style="padding-left: 0px; font-size: 28px"><i class="fa fa-book" aria-hidden="true"></i> Sales Report</h3>
          </div>

          <!-- /.box-header -->
          <div class="box-body">
        <form name="search" method="POST" action="<?php echo base_url() ?>reports/salesReport">
            <div class="box-header">
  ...
  ?>  
              ...
              <div class="col-md-2">
               ...
               <div class="col-md-2">
                ...
                <div class="col-md-2">
                  <div class="form-group">
                    <label for="gross_amount" class=" control-label" style="text-align:left;">Sales Type </label>
                    
                      <select class="form-control select_group" name="sales_type">
                        <option value="0">Select All</option>
                        <?php foreach ($salestype as $key => $value) { ?>
                          <option value="<?php echo $value->id; ?>"><?php echo $value->name; ?></option>
                        <?php } ?>
                      </select>
                                ...
                                <table border="1" id="test_table"  width="100%" >
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td style="text-align: center; font-size: 15px; font-weight: bold;">&nbsp; <?php echo $fgprice; ?></td>
                                            <td style="text-align: center; font-size: 15px; font-weight: bold;">&nbsp; <?php echo $fdiscount; ?></td>
                                            <td style="text-align: center; font-size: 15px; font-weight: bold;">&nbsp; <?php echo $ftotgst; ?></td>
                                            <td style="text-align: center; font-size: 15px; font-weight: bold;">&nbsp; <?php echo $fnetamt; ?></td>
                                        </tr>
