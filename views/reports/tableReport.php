      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
             <h3 class="box-title"><span style="padding-left: 0px; font-size: 28px"><i class="fa fa-book" aria-hidden="true"></i> Table/Parcel Wise Report</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
        <form name="search" method="POST" action="<?php echo base_url() ?>reports/tableReport">
            <div class="box-header">
              ...
              <div class="col-md-2">
               ...
               <div class="col-md-2">
                  <div class="form-group">
                    <label for="gross_amount" class=" control-label" style="text-align:left;">Table/Parcel</label>
                    
                      <select class="form-control select_group" name="showWaiter">
            ...
            <div class="table-responsive">
                    ...
                    <table border="1" width="100%" id="printTable">
                        ...
                        <tr>
                            <td>
                                <center>
                                    <h4><b>Table/Parcel Wise Report</b></h4>
                        ...
                        <tr>
                            <td>
                                <table border="1" id="test_table"  width="100%" >
                                    ...
                                    ?>
                                        <tr>
                                            <td style="font-weight: bold; font-size: 15px; text-align: center;">&nbsp;</td>
                                            <td style="font-weight: bold; font-size: 15px; text-align: center;">&nbsp;</td>
                                            <td style="font-weight: bold; font-size: 15px; text-align: center;">&nbsp;</td>
                                            <td style="font-weight: bold; font-size: 15px; text-align: center;">&nbsp;</td>
                                            <td style="font-weight: bold; font-size: 15px; text-align: center;">&nbsp; Total</td>
                                            <td style="font-weight: bold; font-size: 15px; text-align: center;">&nbsp; <?php echo $fgprice; ?></td>
                                            <td style="font-weight: bold; font-size: 15px; text-align: center;">&nbsp; <?php echo $fdiscount; ?></td>
                                            <td style="font-weight: bold; font-size: 15px; text-align: center;">&nbsp; <?php echo $ftotgst; ?></td>
                                            <td style="font-weight: bold; font-size: 15px; text-align: center;">&nbsp; <?php echo $fnetamt; ?></td>
                                        </tr>
