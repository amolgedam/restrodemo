      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            ...
            <h3 class="box-title">
              <span style="padding-left: 11px; font-size: 28px"><i class="fa fa-edit"></i> &nbsp; Update Product</span>
            </h3>
          </div>
          <!-- /.box-header -->
              ...
              <div class="box-body" style="margin-top: 40px">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="sr_no" name="sr_no" placeholder="Enter Product Code" autocomplete="off" value="<?php echo !empty($this->input->post('sr_no')) ?:$product_data['sr_no'] ?>" />
                  </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="hidden" name="category" id="category" value="<?php echo $product_data['category_id'] ?>" class="form-control" readonly>

                      <?php
                        $catData = $this->model_category->getCategoryData($product_data['category_id']);
                        // echo "<pre>"; print_r($catData);
                      ?>

                      <input list="test_1" class="form-control" id="product"  name="product[]" autofocus required value="<?php echo $catData['name']; ?>">
                        <datalist id="test_1" >
                        <option value=""></option>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <select class="form-control" name="gst" >
                        ...
                        <?php foreach ($gst as $row): ?>
                          <option value="<?php echo $row->gst_id ?>" <?php echo $product_data['gst_id'] == $row->gst_id ? "selected" : ""; ?> ><?php echo $row->name ?></option>
                        <?php endforeach ?>
                      </select>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <textarea type="text" class="form-control" name="description" placeholder="Enter description" autocomplete="off"><?php echo !empty($this->input->post('description')) ?:$product_data['description'] ?></textarea>
                    </div>
                </div>
