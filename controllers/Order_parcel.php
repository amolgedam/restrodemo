...
class Order_parcel extends Admin_Controller 
{
	var $currency_code = '';
	...
	*/
	public function fetchOrdersData()
	{
		...
		foreach ($data as $key => $value) {
			...
			$buttons .= '<button type="button" class="btn btn-default">Print Invoice</button>';

			$buttons .= '<button type="button" class="btn btn-default">Print KOT</button>';
	...
	*/
	...
	public function createFromDashboard()
	{
		...
		$this->render_template('orders/createFromDashboard', $this->data);
	}
	...
	public function updateOrderFromDashboard()
	{
		...
		$this->data['table_data'] = $this->model_tables->getActiveTable();
            ...
            $this->render_template('orders/editFromDashboard', $this->data);
	}
