...
class Category extends Admin_Controller 
{
	...
	public function getDataByName()
    {
        ...
        $data = $this->model_category->getDataByName($name);
	...
	public function create()
	{
		...
		$this->form_validation->set_rules('category_name', 'Category;', 'trim|required|is_unique[category.name]');
	...
	public function remove()
	{
		...
		$productData = $this->model_products->existInCatinProduct($category_id);
